...
st.markdown('Escreva o nome do arquivo que deseja salvar')
coluna1, coluna2 = st.columns(2)
with coluna1:
  nome_arquivo = st.text_input('', label_visibility='collapsed', value = 'dados') # remove espaço e não mostra a label
  nome_arquivo += '.csv'
with coluna2:
